...
import { Language,SentimentOfYear,Sentiment,Source,Aspect } from "./DataHeadPhone";
import LineChart from "./LineChart";
import DoughnutChart from "./DoughnutChart";
import 'bootstrap/dist/css/bootstrap.min.css';
import '../App.css';
import '../fonts/B-NAZANIN.TTF';
import Dropdown from 'react-bootstrap/Dropdown';import 'bootstrap/dist/css/bootstrap.css';
    ...
    return (
        ...
        <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
         ...
         <div className='col-1 mt-4'>
          <h4 className='text-dark'>8,010</h4>  
         <p className='text-muted'>کل</p>    
        </div> 
        <div className='col-2 mt-4'>
          <h4 className='text-success'>2,436</h4>  
         <p className='text-muted'>مثبت</p>    
        </div>                    
        <div className='col-1 mt-4'>
          <h4 className='text-info'>1,997</h4>  
         <p className='text-muted'>خنثی</p>    
        </div> 
        <div className='col-2 mt-4'>
          <h4 className='text-danger'>6,000</h4>  
